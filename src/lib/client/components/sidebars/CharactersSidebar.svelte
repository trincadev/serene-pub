...
<div class="text-foreground h-full p-4">
    {#if isCreating}
        <CharacterForm bind:isSafeToClose={isSafeToCloseCharacterForm} closeForm={closeCharacterForm} />
    {:else if characterId}
        <CharacterForm
    ...
    {:else}
        <div class="flex gap-2 mb-2">
            <button class="btn btn-sm preset-filled-primary-500" onclick={handleCreateClick} title="Create New Character">
                <Icons.Plus size={16} />
            </button>
            <button class="btn btn-sm preset-filled-primary-500" title="Import Character" onclick={handleImportClick}>
    ...
    {#snippet content()}
        <div class="p-6">
            ...
            <div class="flex mt-4 gap-2">
                <button class="btn preset-filled-surface-500" onclick={() => (showImportModal = false)}>
                    Cancel
                </button>
            </div>
        </div>
