<script lang="ts">
	...
	import OllamaInstalledTab from "./OllamaInstalledTab.svelte"
	import OllamaAvailableTab from "./OllamaAvailableTab.svelte"
...
<div class="flex h-full flex-col">
	...
	<div class="p-4">
		<div class="flex items-center justify-between">
			<h2 class="mb-4 text-lg font-bold">
				...
				>
					<path
						...
						fill={themeCtx.mode === "dark" ? "#F8F8F8" : "#1A1A1A"}
					/>
					<path
			...
			<button class="mb-4" onclick={close}>
	...
	{:else}
		<!-- Display a "Not Connected, is Ollama installed" -->
		<div class="flex-1 items-center justify-center p-2">
			<div
				class="bg-surface-100-900 card flex max-w-md flex-col gap-8 p-2 text-center"
			>
				<Icons.AlertCircle
					class="text-error-500 mx-auto mb-4 "
					size={64}
				/>
				<div class="flex flex-col gap-2">
					...
					<p class="mb-6 text-sm">
						Please check your connection settings or install Ollama.
					</p>
				</div>
